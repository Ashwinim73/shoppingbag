...
import com.example.shoppingbag.HomeActivity;
import com.example.shoppingbag.MainActivity;
...
public class AdminAddCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maintainProductsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(AdminAddCategoryActivity.this, HomeActivity.class);
        ...
        CheckOrdersBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                Intent intent = new Intent(AdminAddCategoryActivity.this, AdminNewOrdersActivity.class);
                startActivity(intent);
            }
        });
